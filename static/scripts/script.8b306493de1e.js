...
function swapFavicon() {
    if (isDarkFavicon) {
        faviconSwapper.setAttribute('href', '/static/icons/logos/Favicon_dark.svg');
        faviconASwapper.setAttribute('href', '/static/icons/logos/Favicon_dark.svg');
        faviconMSwapper.setAttribute('href', '/static/icons/logos/Favicon_dark.svg');
    } else {
        faviconSwapper.setAttribute('href', '/static/icons/logos/Favicon_light.svg');
        faviconASwapper.setAttribute('href', '/static/icons/logos/Favicon_light.svg');
        faviconMSwapper.setAttribute('href', '/static/icons/logos/Favicon_light.svg');
    }
}
